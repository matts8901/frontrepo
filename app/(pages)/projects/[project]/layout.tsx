...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="sm:max-md:w-full h-[95vh] flex flex-col overflow-hidden ">
        ...
        {isAuthenticated.value && loading === "done" ? (
          ...
          >
            <h3 className="text-white font-sans font-medium text-sm">
              Something went wrong. Please try again later. <br /> Thank you for
              your patience and understanding. <br /> <br /> - Team mallow
            </h3>
          </motion.div>
        ) : (
          <motion.div
